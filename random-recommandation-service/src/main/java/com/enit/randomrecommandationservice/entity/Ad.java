...
//	}
	...
	public Ad(String id,List<String> category, String title, String description, int price, int advertiserPhoneNumber, String country, String state, String city, Status status, String adImagesDirectory, String condition, String model, String brand, int views, float rate, Double[] location) {
		this.category = category;
		this.title = title;
		this.description = description;
		this.id=id;
